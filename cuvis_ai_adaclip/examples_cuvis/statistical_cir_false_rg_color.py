...
DEFAULT_EXPERIMENT_NAME = "statistical_adaclip_cir_false_rg_color_plugin"
DEFAULT_MONITOR_ROOT = CUVIS_AI_ROOT / "outputs" / "tensorboard"
DEFAULT_QUANTILE = 0.995
DEFAULT_MASK_CHANNEL = 0
# CIR false-RG defaults: NIR->R, Red->G, Green(visible)->B
DEFAULT_NIR_NM = 860.0
DEFAULT_RED_NM = 670.0
DEFAULT_GREEN_NM = 450.0
AVAILABLE_BACKBONES = [
    "ViT-L-14-336",
    "ViT-L-14",
    "ViT-B-16",
...
def main(cfg: DictConfig) -> None:
    ...
    logger.info("=== AdaCLIP CIR false-RG example (plugin) ===")
