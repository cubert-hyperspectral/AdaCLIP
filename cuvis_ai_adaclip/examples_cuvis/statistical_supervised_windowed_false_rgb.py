...
DEFAULT_EXPERIMENT_NAME = "statistical_adaclip_supervised_windowed_false_rgb_plugin"
...
DEFAULT_SUPERVISED_WINDOWED_WINDOWS = ((440.0, 500.0), (500.0, 580.0), (610.0, 700.0))
AVAILABLE_BACKBONES = [
    "ViT-L-14-336",
    "ViT-L-14",
    "ViT-B-16",
...
def main(cfg: DictConfig) -> None:
    ...
    windows = tuple(
        getattr(cfg, "supervised_windowed_windows", DEFAULT_SUPERVISED_WINDOWED_WINDOWS)
    )
    score_weights = tuple(
    ...
    logger.info("=== AdaCLIP supervised windowed false-RGB example (plugin) ===")
