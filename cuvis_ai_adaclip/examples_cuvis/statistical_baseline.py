...
# From: AdaCLIP-cuvis/cuvis_ai_adaclip/examples_cuvis/statistical_baseline.py
...
DEFAULT_EXPERIMENT_NAME = "statistical_adaclip_baseline_plugin"
...
def main(cfg: DictConfig) -> None:
    ...
    logger.info("=== AdaCLIP baseline example (plugin) ===")
    ...
    # No statistical fit is required for BaselineFalseRGBSelector / AdaCLIP
